...
#            print(f"[RightFoldHorizontal] Phase 1: {phase1_frames} frames, Phase 2: {phase2_frames} frames")
            ...
            phase1 = render_phase1_frames(ctx, from_img, to_img, num_frames=phase1_frames, direction="right")
            phase2 = render_phase2_frames(ctx, from_img, to_img, num_frames=phase2_frames, direction="right")
